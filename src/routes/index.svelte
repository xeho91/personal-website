...
<Metatags
	...
	description="My space on the Internet. Showcases my stories, developing skills, shared notes, and a way to contact me."
/>
...
<article>
	...
	<Profile>
		<Message>
			My name is <strong>Mateusz Kadłubowski</strong>. Born in <Flag
				name="Poland"
				icon={flagPoland}
