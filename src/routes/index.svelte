...
<article>
	...
	<Profile>
		<Message>
			My name is <strong>Mateusz Kadłubowski</strong>.
			Born in <Flag name="Poland" icon={flagPoland} />,
			and currently, I live in <Flag name="Taiwan" icon={flagTaiwan} />.<br />
			Feel free to call me <em>Matt</em> since Polish words might twist your
			tongue awkwardly. 😉
		</Message>

		<Message>
			I am passionate about <strong>software development and research</strong>.
			I started with <em>Digital Marketing</em>, then <em>Front-end</em>.
		</Message>

		<Message>
			You may notice me as a <strong>big fan <em>(nerd)</em> of terminal</strong>,
			<abbr title="Command Line Interface">CLI</abbr>
			& <abbr title="Terminal User Interface">TUI</abbr> tools.
			Being able to code and solve the cases through it,
			without the need to use <abbr title="Graphical User Interface">GUI</abbr>
		...
		<Message>
			At the moment, I feel the most confident in the <Link wiki="JavaScript" />
		...
		<Message>P.S. I also love <Link wiki="Svelte" />. 💜</Message>
